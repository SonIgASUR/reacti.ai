...
const ProPricing = ({ handlePayment, plan }) => {
  return (
    <div className="w-[90%] vsm:w-[427.79px] h-[427.79px] relative bg-fuchsia-500 rounded-tl-[40.59px] rounded-br-[40.59px] flex flex-col items-center">
      <button onClick={handlePayment} className="text-2xl absolute right-[2.03rem] top-[2.02rem] text-fuchsia-500 bg-white py-2 px-5 rounded-full">
        {" "}
      ...
      <ul className="flex flex-col items-center gap-[19.84px]">
        <li className="text-purple-50 text-xl font-medium">For influencer</li>
