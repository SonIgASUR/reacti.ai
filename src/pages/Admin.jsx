...
const AdminPanel = ({ _hooks }) => {
  const { adminQuery, setIsLoggedIn, customPrompt, setCustomPrompt } = _hooks;
  ...
  const handlePromptSave = async () => {
    ...
    const res = await fetch(import.meta.env.VITE_SERVER_URL + "/admin/prompt", {
      method: "POST",
